...
const Blogs = ({ data }) => {
    return (
        <main className={`${sass.Main}`}>
            <h2 className={`${sass.Heading} text-4xl my-10`} data-aos="fade-up">Recently Posts</h2>
            <div className={`${sass.RecentPosts} flex flex-col items-center mb-8 `}>
                ...
                <Link href="/posts" className={`${sass.Btn}`} data-aos="fade-up" data-aos-duration="700">See More</Link>
            </div>
        </main>
    )
}
